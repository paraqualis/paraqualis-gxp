...
> Not a reproduction of any copyrighted text. For authoritative guidance consult:
> - **ISPE GAMP® Guide: Artificial Intelligence** (July 2025) — companion to GAMP 5
>   (2nd ed.), covering the full AI lifecycle, concept → retirement.
> - **EU GMP draft Annex 22 (Artificial Intelligence)** and the draft **Annex 11**
>   revision (European Commission, July 2025) — the regulatory counterpart.
> Always check the current published/effective status of the EU annexes (drafts as of
> 2025) — use `/eCFR` only for US CFR; the EU texts are separate.
